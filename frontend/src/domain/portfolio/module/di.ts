...
import { IPortfolioRemoveUseCase } from '@/domain/portfolio/interactors/PortfolioRemoveUseCase'
...
export const PortfolioRemoveUseCaseDI = (): IPortfolioRemoveUseCase => DIContainer.get(types.IPortfolioRemoveUseCase)
